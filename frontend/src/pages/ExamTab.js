  ...
  return (
    <Box sx={{ animation: 'fadeUp 0.4s cubic-bezier(0.16,1,0.3,1) both' }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            ...
            <Paper sx={{ bgcolor: '#FFFFFF', border: '1px solid rgba(0,0,0,0.10)', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 1px 4px rgba(0,0,0,0.07)' }}>
              ...
              <Box sx={{ minHeight: 400 }}>
                {!selectedExamId ? (
                  <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', py: 15 }}><InfoIcon sx={{ fontSize: 48, color: '#8A8190', mb: 2 }} /><Typography sx={{ color: '#64748B', fontSize: '0.9375rem', fontWeight: 500 }}>시험을 선택해주세요</Typography></Box>
                ) : currentResults.length === 0 ? (
                  <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', py: 15 }}><SearchIcon sx={{ fontSize: 48, color: '#8A8190', mb: 2 }} /><Typography sx={{ color: '#64748B', fontSize: '0.9375rem', fontWeight: 500 }}>조건에 맞는 학생이 없습니다</Typography></Box>
                ) : (
                  <Table size="small">
                    <TableHead>
                      <TableRow>
          ...
          <Box sx={{ position: 'sticky', top: 20, display: 'flex', flexDirection: 'column', gap: 3 }}>
            <Paper sx={{ bgcolor: '#FFFFFF', border: '1px solid rgba(0,0,0,0.10)', borderRadius: '20px', p: 3, boxShadow: '0 1px 4px rgba(0,0,0,0.07)' }}>
              ...
              {selectedExamId ? (
                ...
                <Box sx={{ py: 5, textAlign: 'center' }}><InfoIcon sx={{ fontSize: 32, color: '#8A8190', mb: 1.5 }} /><Typography sx={{ color: '#64748B', fontSize: '0.75rem' }}>시험을 선택하면<br/>상세 분석이 표시됩니다</Typography></Box>
              )}
            </Paper>
          </Box>
        </Grid>
      ...
      <Dialog open={deleteConfirmOpen} onClose={() => setDeleteConfirmOpen(false)} PaperProps={{ sx: { bgcolor: '#FFFFFF', border: '1px solid rgba(0,0,0,0.10)', borderRadius: '16px' } }}>
        ...
        <DialogActions sx={{ p: 2.5 }}><Button onClick={() => setDeleteConfirmOpen(false)} sx={{ color: '#64748B' }}>취소</Button><Button onClick={handleDeleteExam} sx={{ bgcolor: '#FEE2E2', color: '#DC2626', fontWeight: 700 }}>삭제</Button></DialogActions>
      </Dialog>
