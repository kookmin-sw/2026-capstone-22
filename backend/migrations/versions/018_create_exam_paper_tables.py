"""Create exam paper tables

Revision ID: 018_create_exam_paper_tables
"""
...
revision = "018_create_exam_paper_tables"
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("question_format", sa.String(20), nullable=True),
    ...
    op.create_index(
        "idx_question_item_paper",
        "question_items",
        ["paper_id", "question_number"],
    )
    op.create_index(
        "idx_question_item_tenant_review",
        "question_items",
...
def downgrade():
    op.drop_index("idx_question_item_tenant_review", table_name="question_items")
    op.drop_index("idx_question_item_paper", table_name="question_items")
    op.drop_table("question_items")

    op.drop_index("idx_exam_paper_tenant_status", table_name="exam_papers")
