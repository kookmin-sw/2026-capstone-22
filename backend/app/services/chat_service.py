...
2. PERSONAL: 자녀의 개인 정보/일정/출결 조회. "아이 수업", "우리 아이 반", "자녀 시간표", "아이 출결", "결석", "보강", "자녀 정보", "아이 일정", "담당 선생님" 관련. 자녀의 개인 데이터를 묻는 경우 무조건 PERSONAL.
...
2. 자녀의 개인 데이터를 묻는 경우 → **PERSONAL**.
   - 예: "아이 수업", "우리 아이 반", "자녀 출결", "아이 시간표", "결석", "보강", "분반", "담당 선생님" 등
