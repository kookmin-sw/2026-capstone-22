...
2. PERSONAL: 자녀의 개인 정보/일정/출결 조회. "아이 수업", "우리 아이 반", "자녀 시간표", "아이 출결", "결석", "보강", "자녀 정보", "아이 일정", "담당 선생님", "출결", "시간표" 등. 아래 중 하나라도 해당하면 무조건 PERSONAL:
   - 자녀/아이/애 관련 정보를 묻는 경우 (예: "우리 아이 반", "내 아이 분반", "자녀 시간표")
   - 결석·보강·출결·시간표·분반 등 학원 생활 데이터를 묻는 경우
   - 담당 선생님 정보를 묻는 경우
3. ACADEMIC: 학습 콘텐츠 및 문제 처리. "문제 만들어줘", "유사 문제", "기출 문제", "오답 정리" 관련. (문제가 언급되면 무조건 여기로!)
4. ADMIN: 관리 운영. "상담 요약", "통계", "설정 변경" 관련.

[라우팅 규칙 - 우선순위]
1. 질문에 **'문제', '유사', '유형', '기출'** 단어가 있으면 무조건 **ACADEMIC**.
2. 자녀의 학원 생활 데이터(반, 시간표, 출결, 결석, 보강, 분반)를 묻거나, "아이/자녀/우리 애" 등 자녀 호칭이 포함된 경우 → 무조건 **PERSONAL**.
3. 판단이 모호하면 CONSULTING을 선택하세요.
